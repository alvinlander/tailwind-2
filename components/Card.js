function Card() {
  return (
    <div>
      <div className="bg-white shadow-lg transform rotate-3 hover:rotate-0 transition-all duration-300 rounded-lg overflow-hidden hover:shadow">
        <div className="px-8 py-5 leading-relaxed text-xl text-gray-800">
          <svg
            width="45"
            height="36"
            className="mb-5 fill-current text-gray-100"
          >
            <path d="M13.415.001C6.07 5.185.887 13.681.887 23.041c0 7.632 4.608 12.096 9.936 12.096 5.04 0 8.784-4.032 8.784-8.784 0-4.752-3.312-8.208-7.632-8.208-.864 0-2.016.144-2.304.288.72-4.896 5.328-10.656 9.936-13.536L13.415.001zm24.768 0c-7.2 5.184-12.384 13.68-12.384 23.04 0 7.632 4.608 12.096 9.936 12.096 4.896 0 8.784-4.032 8.784-8.784 0-4.752-3.456-8.208-7.776-8.208-.864 0-1.872.144-2.16.288.72-4.896 5.184-10.656 9.792-13.536L38.183.001z"></path>
          </svg>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque
          corporis sequi, voluptates doloremque officia nostrum dolores
          repudiandae mollitia fugiat. Amet doloremque suscipit quia
          exercitationem minima asperiores molestiae quisquam dolore autem.
        </div>
        <div className="px-8 py-5 bg-gradient-to-br from-gray-500 to-gray-700 flex items-center justify-between">
          <div className="flex items-center">
            <div className="flex-shrink-0 mr-3">
              <img
                className="w-12 h-12 rounded-full border-2 border-white"
                src="https://avatars0.githubusercontent.com/u/39526830?s=460&u=70a056fcb1c4f56a97741174b3df22c7baf3c62b&v=4"
                alt="alvin"
                srcset=""
              />
            </div>
            <div className="text-white">Alvin Lander</div>
          </div>
          <a
            href="#"
